...
internal fun Source.discard(
  ...
  try {
    ...
    // Parser policy violations must reach the caller; treating them as an ordinary failed drain
    // would let a response with over-budget trailers appear successful.
    throw e
  } catch (_: IOException) {
    false
  }
